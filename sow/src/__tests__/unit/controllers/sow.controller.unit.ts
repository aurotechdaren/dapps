...
describe('SowController (unit)', () => {
  ...
  describe('replaceSow', () => {
    it('successfully replaces existing items', async () => {
      ...
      await controller.replaceById(aSowWithId.id as string, aChangedSow);
  ...
  describe('deleteById()', () => {
    it('successfully deletes existing items', async () => {
      deleteById.resolves();
      await controller.deleteById(aSowWithId.id as string);
  ...
  describe('count()', () => {
    it('returns the number of existing sowLists', async () => {
      ...
      expect(await controller.count()).to.eql(aListOfSows.length);
